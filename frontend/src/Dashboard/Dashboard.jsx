...
const Dashboard = () => {
    ...
    return (
        <div className={'p-4 sm:p-8'}>
            ...
            {/* Team table */}
            <section className={'overflow-x-scroll mt-8'}>
                {/*Table Header Count*/}
                <div>
                    {members?.length > 0 && (
                ...
                {members && members.length > 0 && (
                    <div
                        className={'grid mb-4 py-2 font-bold border border-neutral-600  sm:grid-cols-5 gap-x-4 rounded-md bg-neutral-700 sm:items-center px-2'}>
                        <p>Username</p>
                        <p>Project</p>
                        <p>Role</p>
                        <p>Action</p>
                ...
                <div className={'rounded-md flex flex-col gap-y-2 overflow-x-auto'}>
                    {members && members.length > 0 && (
                        members.map(member => (
