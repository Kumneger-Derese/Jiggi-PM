...
const useMoveCard = activeCard => {
    ...
    return useMutation({
        ...
        onMutate: async (variables) => {
            ...
            const cardsQueryKeys = queryClient
                .getQueryCache()
                .findAll({queryKey: ['cards']})
            ...
            queryClient.setQueryData(['cards', newListId], old => {
                ...
                return old
                    ? [...old, newCard].sort((a, b) => a.position - b.position)
                    : [newCard]
            })
        ...
        onSuccess: (result, variables) => {
            ...
            queryClient.invalidateQueries({
                queryKey: ['cards', activeCardId]
            })
            queryClient.invalidateQueries({
                queryKey: ['cards', newListId]
            })
...
const useReorderCard = () => {
    ...
    return useMutation({
        ...
        onMutate: async variables => {
            ...
            queryClient.setQueryData(['cards', listId], old => {
                if (!old) return old
