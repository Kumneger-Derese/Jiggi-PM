...
const ListContainer = ({
  ...
  if (isDragging) {
    return (
      <div
        ...
        style={style}
        className={
          'w-80  h-[480px] min-h-[480px] p-[3px] flex flex-col rounded-xl border-2 border-sky-600 bg-neutral-800 opacity-60'
        }
      />
    )
  }
  ...
  return (
    <div
      ...
      style={style}
      className={
        'w-80 h-[650px] min-h-[650px] md:h-[450px] md:min-h-[450px] p-[3px] flex flex-col rounded-xl border border-neutral-600 bg-neutral-800'
      }
    >
      {/*List title*/}
      <div
        ...
        {...listeners}
        className={
          'font-semibold cursor-grab text-neutral-200 flex justify-between items-center bg-neutral-600 line-clamp-1 rounded-md p-2'
        }
      >
        <div
          className={
            'flex items-center justify-center py-1 px-2 rounded-full text-sm bg-neutral-800'
          }
        >
          {cards?.length}
        </div>
      ...
      {/*list tasks*/}
      <div
        className={'flex flex-col flex-1 p-2 overflow-x-hidden overflow-y-auto'}
      >
      ...
      <button
        ...
        className={
          'm-2 py-2 bg-sky-500 hover:ring-sky-100 transition-colors duration-300  ring-2 font-semibold text-neutral-800 rounded-md'
        }
      >
        Add Task
      </button>
