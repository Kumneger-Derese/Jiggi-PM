      ...
      <div className='min-h-screen p-8 overflow-x-auto overflow-y-hidden flex flex-col m-auto w-full'>
        ...
        >
          ...
          <div className='m-auto flex gap-4'>
            ...
            <button
              className={
                'w-80 h-[650px] min-h-[650px] md:h-[450px] md:min-h-[450px] cursor-pointer hover:ring-2 ring-sky-500 hover:border-none flex items-center justify-center rounded-xl border border-neutral-400 bg-neutral-800 p-4 hover:text-sky-500'
              }
              onClick={() => setIsCreateModalOpen(true)}
            >
              <HiPlus size={80} />
